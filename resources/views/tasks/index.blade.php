            ...
            <div class="element-wrapper">
                ...
                <div class="element-box">
                    <div class="text-right">
                        <a href="{{ url('tasks/create') }}" class="mr-2 mb-2 btn btn-primary">New Task</a>
                    </div>
                        ...
                        <table class="table table-lightborder">
                            ...
                            @forelse($tasks as $task)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url("tasks/" . $task->getRouteKey()) }}"
                                           class="btn btn-info btn-sm ">
                                            Show
                                        </a>
                                    </td>
                                    <td>
                                        <a href="{{ url("tasks/{$task->pkey}/edit") }}"
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ url("tasks/{$task->pkey}") }}" method="POST">
                                            {{ csrf_field() }}
                                            {{ method_field('DELETE') }}
