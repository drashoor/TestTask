        ...
        <ul class="main-menu">
            <li class="has-sub-menu">
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a href="apps_support_dashboard.html">Dashboard 2 <strong
            ...
            <li class="has-sub-menu">
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a href="apps_bank.html">Side Menu V2 <strong
                                    class="badge badge-danger">New</strong></a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="apps_projects.html">Side &amp; Top <strong
                                    class="badge badge-danger">New</strong></a>
                    </li>
                    <li>
            ...
            <li class="has-sub-menu">
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a href="apps_support_dashboard.html">Support Dashboard <strong
                                    class="badge badge-danger">New</strong></a>
                    </li>
                    <li>
                        <a href="apps_support_index.html">Tickets Index <strong
                                    class="badge badge-danger">New</strong></a>
                    </li>
                    <li>
                ...
                <div class="sub-menu-w">
                    ...
                    <div class="sub-menu-i">
                        <ul class="sub-menu">
                            ...
                            <li>
                                <a href="apps_bank.html">Dashboard 4 <strong
                                            class="badge badge-danger">New</strong></a>
                            </li>
                            <li>
                                <a href="layouts_menu_top_image.html">Dashboard 5</a>
